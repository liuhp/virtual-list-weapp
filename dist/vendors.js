...
function createGetter(isReadonly = false, shallow = false) {
    return function get(target, key, receiver) {
        ...
        if (isRef(res)) {
            ...
            const shouldUnwrap = !targetIsArray || !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_0__[/* isIntegerKey */ "t"])(key);
...
function baseCreateRenderer(options, createHydrationFns) {
    ...
    const setupRenderEffect = (instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) => {
        ...
        const effect = (instance.effect = new _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__[/* ReactiveEffect */ "b"](componentUpdateFn, () => queueJob(instance.update), instance.scope // track it in component's effect scope
        ));
